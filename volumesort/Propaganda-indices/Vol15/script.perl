...
for ($x = 0; $x < $#files + 1; $x++) {
        ...
        if ($x > 0) {
                ...
                $prev = "<A HREF=../Vol12/catalog.html>&lt; &lt; PREVIOUS VOLUME</A>";
        } else {
        ...
        if ($x < $#files) {
                ...
                $next = "<A HREF=../Vol13/catalog.html>NEXT VOLUME &gt; &gt;</A>";
        } else {
...
FACE="helvetica,arial">Volume 13: Mickeysoft Appreciation Day<br><FONT SIZE=+2>$files[$x]<br><FONT SIZE=0></FONT></TD>
