...
for ($x = 0; $x < $#files + 1; $x++) {
        ...
        if ($x > 0) {
                ...
                $prev = "<A HREF=../Vol13/catalog.html>&lt; &lt; PREVIOUS VOLUME</A>";
        } else {
        ...
        if ($x < $#files) {
                ...
                $next = "<A HREF=../Vol14/catalog.html>NEXT VOLUME &gt; &gt;</A>";
        } else {
...
FACE="helvetica,arial">Volume 14: Rebirth<br><FONT SIZE=+2>$files[$x]<br><FONT SIZE=0></FONT></TD>
...
<HR NOSHADE SIZE=1>
<FONT SIZE=-2>This image is Copyleft &copy; 1998,1999 Bowie J. Poag, Naru Sundar / PROPAGANDA  
